...
from signLanguage.configuration.s3_operaion import S3Operation
...
class TrainPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifact :DataIngestionArtifact)-> DataValidationArtifact:
        logging.info("Entered the start_data_validation method in TrainingPipeline")
        try:
            ...
            logging.info("Performed the data validation operaion")

            logging.info("Exited the start_data_validation method")
